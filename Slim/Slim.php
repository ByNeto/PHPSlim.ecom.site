...
*/
	...
	public static function ControllerView($route){
		$route = require_once('Views/view.'.$route.'.php');
	return $route;
...
<head>
    ...
    <meta name='description' content='Autopec Pecas'/>
    ...
    <!-- Fav Icon -->
    <link rel='canonical' href='https://www.autopec.com.br'/>
    <link rel='shortcut icon' href='../Library/imagens/icons/favicon/favicon.png'>
    <link rel='apple-touch-icon' href='../Library/imagens/icons/favicon/favicon.png'>
    <link rel='apple-touch-icon' sizes='72x72' href='../Library/imagens/icons/favicon/favicon72x72.png'>
    <link rel='apple-touch-icon' sizes='114x114' href='../Library/imagens/icons/favicon/favicon114x114.png'>
    <link rel='apple-touch-icon' sizes='144x144' href='../Library/imagens/icons/favicon/favicon144x144.png'>
    <link rel='apple-touch-startup-image' href='../Library/imagens/icons/favicon/favicon320x460.png'/><!----320x460.png--->
    <!-- Latest compiled and minified CSS -->
    <link rel='stylesheet' href='https://fonts.googleapis.com/css?family=Lato:400,700,900'/>
    <link rel='stylesheet' href='https://cdnjs.cloudflare.com/ajax/libs/font-awesome/4.7.0/css/font-awesome.min.css'/>
    <!-- Bootstrap core CSS -->
    <link rel='stylesheet' href='../Library/vendor/bootstrap/css/bootstrap.min.css' media='screen'/>
    <!-- Custom Style core CSS -->
    <link rel='stylesheet' href='../Library/vendor/custom/style.css' media='screen'/>
    <!-- Style Slider core CSS -->
    <link rel='stylesheet' href='../Library/vendor/custom/flickity.css' media='screen'/>
    <script language='JavaScript' type='text/javascript' src='../Library/vendor/js/render-time-site-scope.js'></script>
    <script language='JavaScript' type='text/javascript' src='../Library/vendor/js/url-path.js'></script>
    <script language='JavaScript' type='text/javascript' src='../Library/vendor/jquery/jquery-1.4.2.js'></script>
    <script language='JavaScript' type='text/javascript' src='../Library/vendor/jquery/jquery.autocomplete.js'></script>
    <script language='JavaScript' type='text/javascript' src='../Library/vendor/js/autocomplete.js'></script>
    <style>.ac_loading{background:#f9f9f9 url('../Library/imagens/loading/loading.gif') right center no-repeat;color:#000;}</style>
</head>
<header class='menu_fixo'>
    <div class='menu_bg'>
        <div class='content'>
            <div class='menu_empresa'>
                <div class='logo'><a href='../'><img class='img-responsive' src='../Library/imagens/logos/logo.png'/></a></div>
                <div class='social-top'>
                    <a href='https://www.facebook.com/autopec.1' target='_blank'><img src='../Library/imagens/icons/icon-top-facebook.jpg' class='img-responsive float-up'></a>
                    <a href='https://twitter.com/autopec' target='_blank'><img src='../Library/imagens/icons/icon-top-twitter.jpg' class='img-responsive float-up'></a>
                    <a href='https://www.youtube.com/user/autopec1' target='_blank'><img src='../Library/imagens/icons/icon-top-youtube.jpg' class='img-responsive float-up'></a>
                    <a href='https://plus.google.com/+AutopecBr/' target='_blank'><img src='../Library/imagens/icons/icon-top-googlemais.jpg' class='img-responsive float-up'></a>
                </div>
                <ul class='menu_emp_links'>
                    <li><a class='text-shadow' href='../sobrenos/'>Sobre nós</a></li>
                    <li><a class='text-shadow' href='../contato/'>Contato</a></li>
                    <li><a class='text-shadow' href='../localizacao/'>Localização</a></li>
                    <li><a class='text-shadow' href='../blog/'>Blog</a></li>
                </ul>
            </div>
        </div>
    </div>
...
<body>
    <div class='container' id='erro'>
        <div class='row'>
            <div class='col-md-12 col-sm-12 col-xs-12 mensagem'>
                %s
            </div>
...
<div class='container'>
    <br/><div class='row footer-icons-scope'>
        <div class='col-md-3'><a href='../contato/'><img src='../Library/imagens/icons/icon_email.png' class='img-responsive img-fluid float-up'/><font class='font-responsive font-hover'> ENVIE UM E-MAIL</font></a></div>
        <div class='col-md-3'><a href='../blog/'><img src='../Library/imagens/icons/icon_blog.png' class='img-responsive img-fluid float-up'/><font class='font-responsive font-hover'> BLOG AUTOPEC</font></a></div>
        <div class='col-md-3'><a href='http://siacg.com.br/' target='_blank'><img src='../Library/imagens/icons/icon_siagc.png' class='img-responsive img-fluid float-up'/><font class='font-responsive font-hover'> PRODUTOS SIAGC</font></a></div>
    <br/></div>
</div>
<div class='container'><div class='row'><img class='img-responsive img-fluid center-block' src='../Library/imagens/bg/bg-footer.png'/></div></div>
<div class='bg-grey'><br/>
    <div class='container'>
        <div class='row'>
            <div class='col-md-3 col-responsive'>
                <ul>
                    <li><h1 class='titulo_rodape'><img src='../Library/imagens/icons/icon_item.png' class='img-responsive img-fluid'/> Cadastre seu e-mail</h1></li>
                    <li><p><span> Novidades, promoções e dicas<br><span>de manutenção por e-mail.</span></p></li>
                    <li><div class='cadastro_rss'><input class='input-newsletter' id='email' name='email' placeholder='Insira seu e-mail' type='email'><a onclick='validaInputNewsletter();'><img class='img-newsletter img-responsive img-fluid' src='../Library/imagens/icons/icon-newsletter-arrow.jpg'/></a><span id='msg-email'></span></div></li>
                </ul>
            </div>

            <div class='modal fade bd-example-modal-lg' id='ModalNewsletter' tabindex='-1' role='dialog' aria-labelledby='exampleModalLabel' aria-hidden='true'>
                <div class='modal-dialog modal-lg' role='document'>
                    <div class='modal-content'>
                        <div class='modal-header'><h5 class='modal-title'><img class='img-responsive img-fluid' src='../Library/imagens/logos/logo-min.png'/></h5><button type='button' class='close' data-dismiss='modal' aria-label='Close'><span class='text-white' aria-hidden='true'>&times;</span></button></div>
                        <div class='modal-body'><div class='container-fluid'><div class='row'><h4 class='jumbotron'><span id='msg-newsletter'></span></h4></div></div></div>
            ...
            <div class='col-md-2'>
                <ul>
                    <li><h1 class='titulo_rodape'><img src='../Library/imagens/icons/icon_item.png' class='img-responsive img-fluid'/> Empresa</h1></li>
                    <li class='space-bottom'><a class='font-red-hover' href='../sobrenos/'> Quem somos</a></li>
                    <li class='space-bottom'><a class='font-red-hover' href='../localizacao/'> Localização</a></li>
                    <li class='space-bottom'><a class='font-red-hover' href='../trabalheconosco/'> Trabalhe conosco</a></li>
                    <li class='space-bottom'><a class='font-red-hover' href='../blog/'> Blog</a></li>
                </ul>
            </div>
            <div class='col-md-2'>
                <ul>
                    <li><h1 class='titulo_rodape'><img src='../Library/imagens/icons/icon_item.png' class='img-responsive img-fluid'/> Atendimento</h1></li>
                    <li class='space-bottom'><a class='font-red-hover' href='../contato/'> Contato</a></li>
                    <li class='space-bottom'><a class='font-red-hover' href='../politicadeseguranca/'> Política de segurança</a></li>
                    <li class='space-bottom'><a class='font-red-hover' href='../comocomprar/'> Como Comprar</a></li>
                </ul>
            </div>
            <div class='col-md-2'>
                <ul>
                    <li><h1 class='titulo_rodape'><img src='../Library/imagens/icons/icon_item.png' class='img-responsive img-fluid'> Compras</h1></li>
                    <li class='space-bottom'><a class='font-red-hover' href='../trocasedevolucoes/'> Trocas e devoluções</a></li>
                    <li class='space-bottom'><a class='font-red-hover' href='../termosdevendas/'> Termos de vendas</a></li>
                    <li class='space-bottom'><a class='font-red-hover' href='../formasdepagamentos/'> Formas de Pagamento</a></li>
                </ul>
            </div>
            <div class='col-md-3 col-responsive'>
                <ul>
                    <li><h1 class='titulo_rodape'><img src='../Library/imagens/icons/icon_item.png' class='img-responsive img-fluid'/> Acompanhe</h1></li>
                    <li>
                        <div class='row center-block'>
                            <a href='https://plus.google.com/+AutopecBr/' target='_blank'><img class='img-responsive img-fluid space-left float-up' src='../Library/imagens/icons/icon_googlemais.jpg'/></a>
                            <a href='https://www.facebook.com/autopec.1' target='_blank'><img class='img-responsive img-fluid space-left float-up' src='../Library/imagens/icons/icon_facebook.jpg'/></a>
                            <a href='https://twitter.com/autopec' target='_blank'><img class='img-responsive img-fluid space-left float-up' src='../Library/imagens/icons/icon_twitter.jpg'/></a>
                            <a href='https://www.youtube.com/user/autopec1' target='_blank'><img class='img-responsive img-fluid space-left float-up' src='../Library/imagens/icons/icon_youtube.jpg'/></a>
                        </div>
                    </li>
                </ul>
            </div>
...
" ,$title, $body);
    ...
    {
        echo static::generateTemplateMarkup('<h1>ERRO 404</h1><p>Página não encontrada :(</p>', '<h2>Desculpe, a página que você está<br/> procurando não existe.</h2><p><a href="./"><i class="fa fa-television" aria-hidden="true"></i>Voltar ao site</a></p><img src="../Library/imagens/animacao.gif" />');
    }
