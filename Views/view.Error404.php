...
<div class="container" id="erro">
	<div class="row">
		...
		<div class="col-md-12 col-sm-12 col-xs-12 home">
			<h2>Desculpe, a página que você está<br/> procurando não existe.</h2>
			<p><a href="<?php print_r($objFunctionClass->UrlFixed());?>"><i class="fa fa-television" aria-hidden="true"></i>Voltar ao site</a></p>
			<img src="<?php print_r($objFunctionClass->UrlFixed());?>/Library/imagens/animacao.gif" />
		</div>
	</div>
</div>
