...
<div class="container">
	<div class="col-md-12 col-xs-12">
		<h1 class="font-bold text-red font-uppercase">Localização</h1>
		<p class="text-default">A Autopec está atualmente localizada na cidade de Campinas/SP.<br>Faça-nos uma visita!</p>
	</div>
	<div class="col-md-12 col-xs-12">
		<div class="form-inline input-group">
			<div id="input-address-hidden"></div>
			<input type="text" id="txtDestino" name="txtDestino" class="campomeio_esq_rotas form-control" placeholder="Insira sua localização" required />
			<input class="btn btn_rotas" type="submit" value="Criar Rotas" onclick="CalculateDistance()">
		</div>
	<div id="return-route"></div>
	</div>
	<br/>
	<div class="col-md-12 col-xs-12">
	...
	<div class="container space-bottom">
		<div class="col-md-12 col-xs-12 col-responsive bg-black">
			<div class="container-fluid">
				<div class="text-center">
					<br>
					<p class="text-white">Rua Sargento João Batista Sarubbi, 77 - Jd. Eulina - Campinas-SP 13063-340, Brasil (19) 3241-5341</p>
					<p class="text-white">Horário de atendimento: Segunda à Sexta-Feira 08:00 - 18:00 horas | Sábados 08:00 - 12:00 horas</p>
					<br/>
				</div>
			</div>
			<div class="row space-bottom">
				<div class="col-md-1 col-xs-1 col-responsive">&nbsp;</div>
				<div class="col-md-5 col-xs-5 col-responsive text-center bg-orange-hover" onclick="Filial();" title="Clique para trocar o mapa" data-toggle="tooltip" data-placement="bottom">
					<p class="text-white space-top"><strong>Filial: 04.014.192/0002-27</strong></p>
					<p class="text-white">Rua Sargento João Batista Sarubbi, 77</p>
					<p class="text-white">Jd. Eulina - Campinas - 13063-340 </p>
				</div>
				<div class="col-md-5 col-xs-5 col-responsive text-center bg-orange-hover" onclick="Matriz();" title="Clique para trocar o mapa" data-toggle="tooltip" data-placement="bottom">
					<p class="text-white space-top"><strong>Matriz: 04.014.192/0001-46</strong></p>
					<p class="text-white">Rua Jose Alves Moreira, 136</p>
					<p class="text-white">Pq. Via Norte - Campinas - 13065-712</p>
				</div>
				<div class="col-md-1 col-xs-1 col-responsive">&nbsp;</div>
			</div>
		</div>
...
<!-- Core JavaScript -->
<script language="JavaScript" type="text/javascript" src="https://maps.google.com/maps/api/js?key=AIzaSyD_DjPTryLFbVp4pgdNFJOiRH3iQN9PPQk"></script>
...
<script language="JavaScript" type="text/javascript" src="<?php print_r($objFunctionClass->UrlFixed());?>/Library/vendor/js/map-location.js"></script>
