...
<div class="container">
	<center>
		<img src="<?php print_r($objFunctionClass->UrlFixed()); ?>/Library/imagens/blog/blog-banner.jpg" class="img-responsive margin-left" width="101%" />
	</center>
	<div class="row space-top">
		<div class="col-md-7 col-xs-7">
			<h1 class="text-gray">Bem vindo ao Blog da Autopec</h1>
			<div class="blog-notice">
				<h2 class="blog-title">Uso severo: saiba o que é e como agir nesses casos</h2>
				<p class="admin">Por :<span> admin</span></p>
				<p class="date-post text-gray"><img src="<?php print_r($objFunctionClass->UrlFixed()); ?>/Library/imagens/icons/icon_date.png"> publicado em 05/07/2017</p>
				<img src="<?php print_r($objFunctionClass->UrlFixed()); ?>/Library/imagens/blog/blog-img1.jpg" class="img-responsive" width="99%">
				<div class="blog-description">
					<p class="text-gray">Lorem ipsum dolor sit amet, consectetur adipiscing elit.
					Phasellus pharetra nec metus sit amet consequat. Ut ultricies,
					massa at faucibus varius, dolor mi fringilla arcu, sit amet susci
					pit neque metus quis enim. Sed ac tristique tellus...</p>
				</div>
				<a href="noticia.php" class="btn_blog">Continuar lendo</a>
			</div>
			<div class="blog-notice">
					<h2 class="blog-title">Maio Amarelo - Especial motos</h2>
					<p class="admin">Por :<span> admin</span></p>
					<p class="date-post text-gray"><img src="<?php print_r($objFunctionClass->UrlFixed()); ?>/Library/imagens/icons/icon_date.png"> publicado em 05/07/2017</p>
					<img src="<?php print_r($objFunctionClass->UrlFixed()); ?>/Library/imagens/blog/blog-img2.jpg" class="img-responsive" width="99%">
					<div class="blog-description">
						<p class="text-gray">Lorem ipsum dolor sit amet, consectetur adipiscing elit.
						Phasellus pharetra nec metus sit amet consequat. Ut ultricies,
						massa at faucibus varius, dolor mi fringilla arcu, sit amet susci
		...
		<div class="col-md-5 col-xs-5">
			<div class="sidebar-archives">
				<h4 class="text-gray"><img src="<?php print_r($objFunctionClass->UrlFixed()); ?>/Library/imagens/icons/icon_item.png" class="icon-title">Rede Sociais</h4>
				<a href="#"><img class="icon-sidebar float-up" src="<?php print_r($objFunctionClass->UrlFixed()); ?>/Library/imagens/icons/icon_googlemais.jpg"></a>
				<a href="#"><img class="icon-sidebar float-up" src="<?php print_r($objFunctionClass->UrlFixed()); ?>/Library/imagens/icons/icon_facebook.jpg"></a>
				<a href="#"><img class="icon-sidebar float-up" src="<?php print_r($objFunctionClass->UrlFixed()); ?>/Library/imagens/icons/icon_twitter.jpg"></a>
				<a href="#"><img class="icon-sidebar float-up" src="<?php print_r($objFunctionClass->UrlFixed()); ?>/Library/imagens/icons/icon_youtube.jpg"></a>
			</div>
			<div class="sidebar-archives">
				<h4 class="text-gray"><img src="<?php print_r($objFunctionClass->UrlFixed()); ?>/Library/imagens/icons/icon_item.png" class="icon-title">Arquivo</h4>
				<ul>
				<li><a href="#"><img src="<?php print_r($objFunctionClass->UrlFixed()); ?>/Library/imagens/icons/icon_mais.png"> 2014</a></li>
				<li><a href="#"><img src="<?php print_r($objFunctionClass->UrlFixed()); ?>/Library/imagens/icons/icon_mais.png"> 2015</a></li>
				<li><a href="#"><img src="<?php print_r($objFunctionClass->UrlFixed()); ?>/Library/imagens/icons/icon_mais.png"> 2016</a></li>
				<li><a href="#"><img src="<?php print_r($objFunctionClass->UrlFixed()); ?>/Library/imagens/icons/icon_mais.png"> 2017</a></li>
				</ul>
			</div>
			<div class="sidebar-archives">
				<h4 class="text-gray"><img src="<?php print_r($objFunctionClass->UrlFixed()); ?>/Library/imagens/icons/icon_item.png" class="icon-title">Categorias do Blog</h4>
			<ul>
				<li><a href="#">Afinal, banguela economiza</a></li>
				<li><a href="#">combustíel?</a></li>
				<li><a href="#">Arrefecimento</a></li>
				<li><a href="#">Câmbio</a></li>
				<li><a href="#">Dicas</a></li>
				<li><a href="#">Economia</a></li>
				<li><a href="#">Iluminação</a></li>
				<li><a href="#">Juntas homocinéticas</a></li>
				...
				<li><a href="#">Turbina</a></li>
			</ul>
			</div>
			<div class="sidebar-archives">
				<h4 class="text-gray"><img src="<?php print_r($objFunctionClass->UrlFixed()); ?>/Library/imagens/icons/icon_item.png" class="icon-title"> Catálogos</h4>
				<ul>
				<li><a href="#">Maio Amarelo</a></li>
				<li><a href="#">Catálogo peças Motorcycle</a></li>
				</ul>
			</div>
		</div>
	</div>
...
<script language="JavaScript" type="text/javascript" src="<?php print_r($objFunctionClass->UrlFixed());?>/Library/vendor/js/start-modal-error.js"></script>
