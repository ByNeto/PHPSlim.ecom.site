...
<div class="container">
	<div class="row">
		<h1 class="font-bold text-red font-uppercase space-top space-bottom space-left-rem">Autopec - Formas de Pagamento</h1>
	</div>
	<div class="rows">
		<p class="text-gray"><strong>Pagamentos - Boleto</strong></p>
		<p class="text-gray"><strong>Pagamentos - Cartão de crédito</strong><br/>
		O parcelamento pode ser feito em até 12 vezes sem juros no cartão de crédito.</p><br/>
		<p class="text-gray"><strong>Boleto bancário</strong><br/>
		Opção de pagamento no boleto bancário<br/>
		O boleto bancário deverá ser impresso e poderá ser pago na agência bancária de sua preferência, ou pela internet, até a data do vencimento, sem a necessidade de envio do comprovante de pagamento.</p><br/>
		<p class="text-gray"><strong>-Para que o produto possa ser entregue, é necessária a confirmação do pagamento.<br/>
		-Não é possível realizar o pagamento do boleto com cheques.<br/>
		-Para pedidos de boleto bancário, o prazo para envio da confirmação pelo banco é de três dias úteis.</strong><br/>
		Caso não seja efetuado o pagamento até a data do vencimento, sucederá o cancelamento automático do pedido, sem qualquer ônus ao cliente.</p><br/>
		<p class="text-gray"><strong>Cartão de crédito</strong><br/>
		Opção de pagamento no cartão de crédito MasterOpção de pagamento no cartão de crédito Visa</p><br/>
		<p class="text-gray">Nas compras efetuadas por meio de cartão de crédito, o pedido está sujeito à aprovação da OPERADORA. <br/>
		Caso não seja possível concluir o pagamento, o cliente será informado, devendo entrar em contato com a Administradora, para verificar o motivo do impedimento.</p><br/>
		<p class="text-gray"><strong>-Não são aceitos cartões emitidos no exterior. <br/>
		-Não é possível realizar o pagamento com mais de um cartão de crédito.<br/>
		-O prazo da entrega ocorrerá a partir da confirmação do pagamento.</strong></p><br/>
		<p class="text-gray">A fim de garantir a segurança dos clientes, as compras realizadas estão sujeitas a confirmação de alguns dados e envio de documentos à <strong>Autopec</strong>. Isso porque algumas pessoas realizam compras pela internet com o cartão de terceiros sem que os verdadeiros proprietários do cartão tenham conhecimento. </p><br/>
		<p class="text-gray"><strong>Informações adicionais</strong><br/>
		Os preços e formas de pagamento apresentados não são iguais aos apresentados nas loja física da <strong>Autopec</strong>. Os preços dos produtos divulgados no site da <strong>Autopec</strong> podem sofrer alteração a qualquer momento sem aviso prévio, exceto para pedidos efetivamente formulados e aceitos. Caso exista alguma diferença nos preços ofertados, será considerado válido o preço disposto no detalhamento do produto. As ofertas anunciadas são válidas por tempo determinado e/ou enquanto durarem os estoques.
		<p class="text-gray">Finalizado o pedido, caso ocorra algum problema com o pagamento ou mude de ideia quanto à forma de pagamento, existe a possibilidade de refazer o pagamento. Caso já tenha realizado o pagamento e possua alguma dúvida, por favor, entre em contato por um de nosso canais de atendimento.</p><br/>
		<p class="text-gray">Em caso de divergência entre os dados cadastrais e de pagamento, a <strong>Autopec</strong> entrará em contato via e-mail ou telefone para instruções acerca do procedimento a ser adotado.</p><br/>
		<p class="text-gray"><strong>Código de Defesa do Consumidor</strong><br/>
		As compras feitas por cartão são realizadas em transações seguras e o cartão passará por nossa equipe de controle de fraudes, garantindo a finalização segura de sua compra. </p><br/>
		<p class="text-gray"><strong>Observação:</strong><br/> Não aceitamos cartões emitidos fora do Brasil. As opções de pagamento a prazo estão sujeitas a requisitos e condições específicas e poderão sofrer alterações de acordo com a política das administradoras dos cartões de crédito.</p> <br/>
		<p class="text-gray"><strong>IMPORTANTE:</strong><br/> Para compras através de <strong>cartão de crédito</strong>, o endereço de entrega do pedido deverá ser <strong>o mesmo endereço que consta na fatura do cartão.</strong> Caso a operadora não confirme esses dados, solicitaremos o envio de documentos do comprador, como cópia da fatura do cartão onde conste o endereço do portador. Caso não consigamos confirmar tais dados, <strong>o pedido pode ser cancelado</strong> para evitar eventual fraude.</p>
	</div>
</div>
