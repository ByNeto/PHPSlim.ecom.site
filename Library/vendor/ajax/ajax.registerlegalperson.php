...
$emailRegisterPj = $objFunctionClass->CheckParameter($objFunctionClass->EmailInjectionSQL($_POST['emailRegisterPj']));
$enterpriseRegisterPj = $objFunctionClass->CheckParameter($objFunctionClass->InjectionSQL($objFunctionClass->ClearString($_POST['enterpriseRegisterPj'])));


$query_Register = $objModelRegister->InsertRegisterLegalPerson($objConn,0,$enterpriseRegisterPj,
$enterpriseRegisterPj,
$objFunctionClass->CheckParameter($objFunctionClass->InjectionSQL($objFunctionClass->ClearString($_POST['logradouroRegisterPj']))),
$objFunctionClass->CheckParameter($objFunctionClass->InjectionSQL($objFunctionClass->ClearString($_POST['numberRegisterPj']))),
$objFunctionClass->CheckParameter($objFunctionClass->InjectionSQL($objFunctionClass->ClearString($_POST['neighborhoodRegisterPj']))),
$objFunctionClass->CheckParameter($objFunctionClass->InjectionSQL($objFunctionClass->ClearString($_POST['cityRegisterPj']))),
$objFunctionClass->CheckParameter($objFunctionClass->InjectionSQL($objFunctionClass->ClearCep($_POST['cepRegisterPj']))),
$objFunctionClass->CheckParameter($objFunctionClass->InjectionSQL($objFunctionClass->ClearString($_POST['ufRegisterPj']))),
$objFunctionClass->CheckParameter($objFunctionClass->InjectionSQL($objFunctionClass->ClearPhone($_POST['telRegisterPj']))),
$objFunctionClass->CheckParameter($objFunctionClass->InjectionSQL($objFunctionClass->ClearPhone($_POST['celRegisterPj']))),
$emailRegisterPj,$objFunctionClass->CheckParameter($objFunctionClass->InjectionSQL($objFunctionClass->ClearCpfCnpj($_POST['stateRegistrationPj']))),$objFunctionClass->CheckParameter($objFunctionClass->InjectionSQL($_POST['cnpjRegisterPj'])),$objFunctionClass->CheckParameter($objFunctionClass->InjectionSQL($objFunctionClass->ClearString($_POST['nameRegisterPj']))),GETDATE(),'J','N','INTERNET',0,$objFunctionClass->CheckParameter($objFunctionClass->InjectionSQL($_POST['segmentPj'])),$objFunctionClass->CheckParameter($objFunctionClass->InjectionSQL($objFunctionClass->ClearCpfCnpj($_POST['cnpjRegisterPj']))),$objFunctionClass->CheckParameter($objFunctionClass->InjectionSQL($_POST['passwordRegisterPj'])),$objFunctionClass->CheckParameter($objFunctionClass->InjectionSQL($_POST['otherRegisterPj'])),$objFunctionClass->CheckParameter($objFunctionClass->InjectionSQL($_POST['completeRegisterPj'])),$objFunctionClass->CheckParameter($objFunctionClass->InjectionSQL($_POST['stateRegistrationPj'])));
...
<body>
	<table align="center">
		...
		<tr>
			<th valign="top" width="700px">
				<p style="text-align:center;font-family: Open Sans, sans-serif;font-weight:400;font-size:16px;color:#000000;padding:0 30px;margin-top:10px;"><strong>Prezado(a) '.$enterpriseRegisterPj.'.</strong></p>
	...
	$AddAddressEmail = $emailRegisterPj;
	$AddAddressName = $enterpriseRegisterPj;
