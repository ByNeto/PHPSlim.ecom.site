...
$objModelCart = new ModelCart();//inicia a classe ModelCart.
$objFunctionClass = new FunctionClass();//inicia a classe FunctionClass.
$return="";
$qtd="";
$query_SelectCheckProductStorage = $objModelCart->SelectCheckProductStorageCart($objConn,$objFunctionClass->CheckParameter($_POST['idCar']),$objFunctionClass->CheckParameter($_POST['codAutopec']));
