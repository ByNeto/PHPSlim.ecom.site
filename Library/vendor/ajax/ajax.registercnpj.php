...
$query_Select=$objModelRegister->SelectRegisterCnpj($objConn,$objFunctionClass->CheckParameter($objFunctionClass->InjectionSQL($objFunctionClass->ClearCpfCnpj($_POST['cnpjRegisterPj']))));

if($fetch_Select=$query_Select->fetch(PDO::FETCH_ASSOC)){print_r($fetch_Select['CNPJSemMask']);}
